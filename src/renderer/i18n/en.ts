export const en: Record<string, string> = {
	...
	"timeline.requestFailed": "Request failed",
	"timeline.requestAborted": "Request aborted",
	"timeline.runtimeEvent": "Runtime event",
	"timeline.extensionError": "Extension error",
	"timeline.retrying": "Retrying request",
	"timeline.retryingDetail": "Attempt {{attempt}} of {{maxAttempts}} in {{delay}}\n{{error}}",
	"timeline.retryRecovered": "Request recovered",
	"timeline.retryFailed": "Retry failed",
	"timeline.compacting": "Compacting context",
	"timeline.compacted": "Context compacted",
	"timeline.compactionRetrying": "Context compacted, retrying",
	"timeline.compactionFailed": "Compaction failed",
	"timeline.compactionCancelled": "Compaction cancelled",
	"timeline.compactionReason": "Reason: {{reason}}",
	"timeline.compactionReasonManual": "manual",
	"timeline.compactionReasonThreshold": "context threshold",
	"timeline.compactionReasonOverflow": "context overflow",
	"timeline.compactionReasonUnknown": "unknown",
