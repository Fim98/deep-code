	...
	return (
		<div
			className={cn(
				...
				"group-data-[role=user]/message:rounded-[12px]",
				"group-data-[role=user]/message:bg-muted group-data-[role=user]/message:px-4 group-data-[role=user]/message:py-2.5",
				"group-data-[role=user]/message:text-foreground",
				className,
			)}
			{...props}
		/>
