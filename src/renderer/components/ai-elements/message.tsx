...
export function MessageResponse({
	...
	return (
		<Streamdown
			...
			lineNumbers={false}
			className={cn(
				"message-response text-[15px] leading-7 text-foreground",
				...
				"[&_pre]:my-4 [&_pre]:max-w-full [&_pre]:overflow-auto [&_pre]:rounded-[18px] [&_pre]:border [&_pre]:border-border/60 [&_pre]:bg-foreground/[0.035] [&_pre]:p-4",
